...
<div id="MainArea">
    <table class="TableStyle">
		...
		<s:iterator value="#queTypeList">
			<tr class="TableDetail1 template">
				<td>${id }</td>
				<td>${name}&nbsp;</td>
				<td>
				<s:a action="queTypeAction_delete?id=%{id}" onClick="return window.confirm('您确定要删除${name}吗？')">删除</s:a>
					<s:a action="queTypeAction_editUI?id=%{id}">修改</s:a>
				</td>
			</tr>
        </s:iterator>
    ...
    <div id="TableTail">
        <div id="TableTail_inside">
           <s:a action="queTypeAction_addUI"><img src="${pageContext.request.contextPath}/style/images/createNew.png" /></s:a>
        </div>
    </div>
</div>
